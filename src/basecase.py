...
# )
 ...
 [ 3983.05423792, 10854.64561088 , 1998.63854871],]
    ...
    plt.subplot(121)
    plt.imshow(prior, extent=(0, pixel_size*prior.shape[0], 0, pixel_size*prior.shape[1]), origin='lower', cmap="bone", vmin=0.0, vmax=1.0) 
    plt.colorbar()
    ...
    plt.imshow(scoring.discovery_score_map(discovery, prior), extent=(0, pixel_size*discovery.shape[0], 0, pixel_size*discovery.shape[1]), origin='lower', cmap="bone", vmin=0.0, vmax=1.0)
    ...
    print("total coverage", discovered_percentage)
